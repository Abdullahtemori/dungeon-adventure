...
public final class CombatEvent implements Serializable {
    ...
    public String toString() {
        switch (myType) {
            ...
            case ATTACK_BLOCKED:
                return myTarget + " blocked " + myActor + "'s attack.";
            case MONSTER_HEAL:
            ...
            case SPECIAL_SUCCESS:
                return myActor + "'s special skill hits " + myTarget
                        + " for " + myAmount + " damage.";
            case SPECIAL_FAIL:
                return myActor + "'s special skill failed.";
            case SPECIAL_CAUGHT:
                return myActor + " was caught attempting a special skill.";
            case SPECIAL_HEAL:
                return myActor + " heals self for " + myAmount + " HP.";
            case ITEM_UNAVAILABLE:
                return myActor + " has none of that item left.";
            case COMBAT_END:
                return myAmount == 1
                        ? myActor + " won the fight against " + myTarget + "."
                        : myTarget + " was defeated by " + myActor + ".";
            default:
                return myType + " " + myActor + " " + myTarget + " " + myAmount;
        }
    }
}
